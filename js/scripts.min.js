...
function Ascroll() {
	...
	var Ra = a.getBoundingClientRect(),
      R = Math.round(Ra.top + b.getBoundingClientRect().height - document.querySelector('.guard-lozung').getBoundingClientRect().top + 1);  // селектор блока, при достижении верхнего края которого нужно открепить прилипающий элемент;  Math.round() только для IE; если ноль заменить на число, то блок будет прилипать до того, как нижний край элемента дойдёт до футера
      if ((Ra.top - P) <= 0) {
      	if ((Ra.top - P) <= R) {
      		b.className = 'stop';
      		b.style.top = - R +'px';
...
$(".magnific").on("click", function() {
	...
	$('.afdgafv').each(function() {
		var imgSlideCount = $(this).find('.sfhjsghfscvdsfg img').length;
		for (var i = 1; i <= imgSlideCount; i++) {
			$(this).find('.sfhjsghfscvdsfg-control').append('<div class="control-item"></div>');		 
		}
		...
		$(this).find(".control-item").hover(function() {
			...
			$(this).parent().parent().find('.sfhjsghfscvdsfg img').hide();
			$(this).parent().parent().find('.sfhjsghfscvdsfg img:eq('+ checkedImg +')').css({
				display: "block"
			});
		});
		//console.log(imgSlideCount);
	});
	$(".rating-fgsfvcvz li").hover(function() {
		var starHover = $(this).index();
		$('.rating-fgsfvcvz li i').removeClass("full");
		$('.rating-fgsfvcvz li:eq('+ starHover +')').prevAll().find("i").addClass("full");
		$('.rating-fgsfvcvz li:eq('+ starHover +')').find("i").addClass("full");
		// $('.rating-fgsfvcvz li').removeClass("active");
		// $('.rating-fgsfvcvz li:eq('+ starHover +')').addClass("active");

		$(this).mouseleave(function() {
			$(".rating-fgsfvcvz li.active").find("i").addClass("full");
			$(".rating-fgsfvcvz li.active").prevAll().find("i").addClass("full");
		});
	});
	$(".rating-fgsfvcvz li").on("click", function() {
		var starHover = $(this).index();
		$('.rating-fgsfvcvz li i').removeClass("full");
		$('.rating-fgsfvcvz li:eq('+ starHover +')').prevAll().find("i").addClass("full");
		$('.rating-fgsfvcvz li:eq('+ starHover +')').find("i").addClass("full");
	...
	$(window).scroll(function(){
		$('.asjkgjsfgksfjgjjskljafklgjfjgksj').toggleClass('vissible', $(this).scrollTop() > 150);
	});
